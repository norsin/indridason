...
<!--<![endif]-->
    ...
    <body>
        ...
        <div class="wrapper start">
                <div class="nav top">
                    <a href="#" class="nav_element left active_nav_gewinnspiel"></a>
                    <a href="buch.html" class="nav_element middle"></a>
                    <a href="autor.html" class="nav_element right"></a>
                </div>
